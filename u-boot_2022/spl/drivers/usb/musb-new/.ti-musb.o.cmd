cmd_spl/drivers/usb/musb-new/ti-musb.o := arm-linux-gnueabihf-gcc -Wp,-MD,spl/drivers/usb/musb-new/.ti-musb.o.d -nostdinc -isystem /home/himanshukitey/opt/gcc-arm-8.3-2019.03-x86_64-arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/8.3.0/include -Ispl/include -Iinclude     -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -Os -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-unused-but-set-variable -Werror=date-time -Wno-packed-not-aligned -ffunction-sections -fdata-sections -fno-stack-protector -Wno-unused-variable -Wno-unused-but-set-variable -Wno-unused-label -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a -D__LINUX_ARM_ARCH__=7 -mtune=generic-armv7-a -I./arch/arm/mach-omap2/include    -DKBUILD_BASENAME='"ti_musb"'  -DKBUILD_MODNAME='"ti_musb"' -c -o spl/drivers/usb/musb-new/ti-musb.o drivers/usb/musb-new/ti-musb.c

source_spl/drivers/usb/musb-new/ti-musb.o := drivers/usb/musb-new/ti-musb.c

deps_spl/drivers/usb/musb-new/ti-musb.o := \
  ...
  drivers/usb/musb-new/musb_regs.h \
    ...
    $(wildcard include/config/usb/musb/fixed/configdata.h) \
  drivers/usb/musb-new/musb_gadget.h \
  drivers/usb/musb-new/musb_host.h \

spl/drivers/usb/musb-new/ti-musb.o: $(deps_spl/drivers/usb/musb-new/ti-musb.o)
