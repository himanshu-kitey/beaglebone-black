...
@ -I ./arch/arm/include -I ./arch/arm/mach-omap2/include
...
@ -mno-unaligned-access -mfloat-abi=soft -mtune=generic-armv7-a -mfpu=neon
@ -mtls-dialect=gnu -march=armv7-a -auxbase-strip spl/./lib/asm-offsets.s
@ -g -Os -Wall -Wstrict-prototypes -Wno-format-security -Wno-pointer-sign
...
@ -fno-PIE -fno-delete-null-pointer-checks -fmacro-prefix-map=./=
...
.LASF40:
	...
	.ascii	"-linux -mno-unaligned-access -mfloat-abi=soft -mtun"
	.ascii	"e=generic-armv7-a -mfpu=neon -mtls-dialect=gnu -mar"
	.ascii	"ch=armv7-a -g -Os -std=gnu11 -fno-builtin -ffreesta"
	.ascii	"nding -fshort-wchar -fno-strict-aliasing -fno-PIE -"
	.ascii	"fno-delete-null-pointer-checks -fstack-usage -fno-s"
	.ascii	"tack-protector -ffunction-sections -fdata-sections "
