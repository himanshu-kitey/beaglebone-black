cmd_tools/boot/image.o := cc -Wp,-MD,tools/boot/.image.o.d -Wall -Wstrict-prototypes -O2 -fomit-frame-pointer   -std=gnu11   -DCONFIG_FIT_SIGNATURE -DCONFIG_FIT_SIGNATURE_MAX_SIZE=0xffffffff -DCONFIG_FIT_CIPHER -include ./include/compiler.h -idirafterinclude -idirafter./arch/arm/include -I./scripts/dtc/libfdt -I./tools -DUSE_HOSTCC -D__KERNEL_STRICT_NAMES -D_GNU_SOURCE  -c -o tools/boot/image.o tools/boot/image.c

source_tools/boot/image.o := tools/boot/image.c

deps_tools/boot/image.o := \
...
tools/boot/image.o: $(deps_tools/boot/image.o)
